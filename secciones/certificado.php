...
agregarImagen($pdf, "../src/certificados_.jpg",0,0);
agregarTexto($pdf,ucwords(utf8_decode($alumno['nombre']." ".$alumno['apellidos'])),130,70,'L',"Helvetica",30,0,84,115);
agregarTexto($pdf,$alumno['nombre_curso'],-180,110,'C',"Helvetica",20,0,84,115);
agregarTexto($pdf,date("d/m/Y"),-220,145,'C',"Helvetica",11,0,84,115);
$pdf->Output();
